...
public class FileReader {
    public List<String> readFileLines(String filename) {
        ...
        try {
            ...
            try {
                // In general, whenever you acquired a ressource (like opening a file),
    ...
    private List<String> readFileLines2(String filename) {
        ...
        // This is just for reference here, I do not require full understanding of what that actually means.

        // A resource acquired in a try-with-resource block initialization, is automatically
